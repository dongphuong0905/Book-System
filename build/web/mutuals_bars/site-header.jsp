<%-- 
    ...
    Created on : Oct 15, 2019, 8:55:18 AM
    Author     : PC
--%>
                            ...
                            <c:choose>
                                <c:when test = "${CurrUser == null}">
                                    <div class="login-block">
                                        <a href="login-register.jsp" class="font-weight-bold">Login</a> <br>
                                        <span>or</span><a href="login-register.jsp">Register</a>
                                    </div>
                                </c:when>
                                <c:when test = "${CurrUser != null}">
                                    <div class="login-block">
                                        <a href="my-account.jsp" class="font-weight-bold">Welcome ${CurrUser.firstname} ${CurrUser.lastname}</a> <br/>
                                        <a href="Logout" class="font-weight-italic">Logout</a>
                                    </div>
                                </c:when>
                            </c:choose>
                                                    ...
                                                    <c:forEach var="item" items="${itemInCart}">
                                                        <div class=" single-cart-block ">
                                                            <div class="cart-product">
                                                                <a href="getproductdetails?bookId=${item.bookId}" class="image">
                                                                    <img src="image/products/cart-product-1.jpg" alt="">
                                                                </a>
                                                                <div class="content">
                                                                    <h3 class="title"><a href="getproductdetails?bookId=${item.bookId}">${item.title}</a>
                                                                    </h3>
                                                                    <p class="price"><span class="qty">${item.quantity} ×</span> ${item.price}</p>
                                                                    <a href="removeproduct?bookId=${item.bookId}" class="cross-btn"><i class="fas fa-times"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>       
                                                    </c:forEach>
