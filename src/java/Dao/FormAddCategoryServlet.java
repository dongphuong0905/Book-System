 ...
 * @author Tran Phuong
 */
@WebServlet(name = "FormAddCategoryServlet", urlPatterns = {"/FormAddCategoryServlet"})
public class FormAddCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Category> list = Admin.getCategory();
