<%-- 
    Document   : index
    Created on : Oct 22, 2019, 2:40:43 PM
    Author     : trong
--%>
        ...
        <div class="container">
            <div class="row align-items-sm-end align-items-center">
                <div class="col-md-4 col-7">
                    <a href="<c:url value="GetAllBook"/>" class="site-brand">
...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 14:09:12 GMT -->
</html>