<%-- 
    ...
    Created on : Nov 4, 2019, 11:47:52 AM
    Author     : trong
--%>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="order-details-list">
                    ...
                    <li>Total: <strong>$${order.totalPrice}</strong></li>
                        <c:if test="${order.paymentMethod == 'CASH'}">
                        <li>Payment Method: <strong>Cash on Delivery</strong></li>
                        </c:if>   
                        <c:if test="${order.paymentMethod == 'CARD'}">
                        <li>Payment Method: <strong>Online Payment</strong></li>
                        </c:if> 
                </ul>
                <c:if test="${order.paymentMethod == 'CASH'}">
                    ...
                    <table class="table order-details-table">
                        ...
                        <tbody>
                            <c:forEach var="item" items="${itemList}">
                                <tr>
                                    <td><a href="getproductdetails?bookId=${item.bookId}">${item.title}</a> <strong>× ${item.quantity}</strong></td>
...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/order-complete.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 14:09:21 GMT -->
</html>
