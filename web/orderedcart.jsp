<%-- 
    Document   : cart
    Created on : Oct 26, 2019, 3:45:38 PM
    Author     : trong
--%>
                        ...
                        <div class="col-lg-6 col-12 d-flex">
                            <div class="cart-summary">
                                <div class="cart-summary-wrap">
                                    ...
                                    <p>Sub Total <span class="text-primary">$${order.totalPrice}</span></p>
                                    <p>Shipping Cost <span class="text-primary">$0</span></p>
                                    <h2>Grand Total <span class="text-primary">$${order.totalPrice}</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 14:09:12 GMT -->
</html>
