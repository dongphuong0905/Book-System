<%-- 
    ...
    Created on : Oct 23, 2019, 7:45:02 AM
    Author     : trong
--%>
...
<%@ include file="/mutual_bars/site-header.jsp" %>
                            ...
                            <div class="product-details-info pl-lg--30 ">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>Product Code: <span class="list-value"> ${book.id}</span></li>
                                        ...
                                        <li>Availability: <span class="list-value" style="color: red"> Out Of Stock</span></li>
                                        </c:if>
                                        <c:if test="${book.amount > 0}">
                                ...
                                <div class="price-block">
                                    <c:if test="${book.promotion == null}">
                                        <span class="price-new">${book.price}</span>
                                    </c:if>
                                    <c:if test="${book.promotion != null}">
                                        <span class="price-new">$${book.price - ((book.price * book.promotion.discount) / 100)}</span>
                                ...
                                <div class="add-to-cart-row">
                                    ...
                                    <div class="add-cart-btn">
                                        <a href="" onclick="this.href = 'addtocart?bookId=${book.bookId}&quantity=' + document.getElementById('qty').value" class="btn btn-outlined--primary"><span class="plus-icon">+</span>Add to
                                            Cart</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7 mt--30 mt-lg--30">
                                        <div class="product-details-info pl-lg--30 ">
                                            ...
                                            <div class="add-to-cart-row">
                                                <div class="count-input-block">
                                                    <span class="widget-label">Qty</span>
                                                    <input type="number" class="form-control text-center" value="1" id="">
                                                </div>
                                                <div class="add-cart-btn">
                                                    <a href="" onclick="this.href = 'addtocart?bookId=${book.bookId}&quantity=' + document.getElementById('qty').value" class="btn btn-outlined--primary"><span class="plus-icon">+</span>Add to
                                                        Cart</a>
    ...
    <!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 14:09:12 GMT -->
</html>
