<%-- 
    Document   : shop-search-result
    Created on : Oct 22, 2019, 2:42:10 PM
    Author     : trong
--%>
            ...
            <main class="inner-page-sec-padding-bottom">
                <div class="container">
                    ...
                    <div class="shop-product-wrap grid with-pagination row space-db--30 shop-border">
                        <c:forEach var="book" items="${bookSearchResult}">
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="getproductdetails?bookId=${book.bookId}">${book.title}</a></h3>
                                        </div>
                                        <div class="product-card--body">
                                            ...
                                            <div class="price-block">
                                                ...
                                                <c:if test="${book.promotion != null}">
                                                    <span class="price">$${book.price - ((book.price * book.promotion.discount) / 100)}</span>
                                                    <del class="price-old">$${book.price}</del>
                                                    <span class="price-discount">${book.promotion.discount}%</span>
                                                </c:if>
...
===================================== -->
    ...
    <!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/shop-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Oct 2019 14:09:20 GMT -->
</html>